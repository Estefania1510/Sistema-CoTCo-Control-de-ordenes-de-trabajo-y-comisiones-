...
// === ROLES ===
$isAdmin     = in_array("administrador", $rolesUsuario);
$isEncargado = in_array("encargado", $rolesUsuario);
$isDisenador = in_array("diseñador", $rolesUsuario);
$isTecnico   = in_array("tecnico", $rolesUsuario);
?>
<!DOCTYPE html>
<html lang="es">
<head>
...
<nav class="sb-topnav navbar navbar-expand navbar-dark" style="background-color: #004aad;">
  ...
  <a class="navbar-brand ps-3 d-flex align-items-center" href="principal.php" 
     style="font-size: 1.8rem; font-weight: bold;">
    ICT
    <img src="../Image/monito.png" alt="Logo" 
         style="height: 45px; width: auto; margin-left: 10px;">
  </a>
    ...
    <nav class="sb-sidenav accordion sb-sidenav-dark" style="background-color: #004aad;">
      ...
      <div class="sb-sidenav-menu">
        <div class="nav">
          ...
          <div class="sb-sidenav-menu-heading" style="color: #ffffff; font-size: 1.2rem;">
            Menú
          </div>
      ...
      <div class="sb-sidenav-footer" style="background-color: #2479df; color: #ffffff;">
          ...
          <?= htmlspecialchars($usuario) ?> (<?= htmlspecialchars(implode(", ", $rolesUsuario)) ?>)
      </div>
